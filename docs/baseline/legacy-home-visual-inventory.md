...
| Desktop بلند 1440×10000 | `legacy-home-long-desktop-1440.png` | ثبت موفق؛ مرجع ترتیب کامل سکشن‌ها |

سه تصویر نخست فقط viewport اولیه را ثبت می‌کنند. تصویر بلند Desktop در بازبینی 2026-08-19 برای پوشش ترتیب کامل Home افزوده شد. داده شخصی یا صفحه authenticated در آن‌ها وجود ندارد.

## ترتیب کامل سکشن‌ها

1. Hero؛
2. پنج کارت مزیت؛
3. جدیدترین دوره‌های ما؛
4. خدمات تخصصی مالی و مالیاتی «راهبر مالی»؛
5. آموزش‌های رایگان؛
6. پرتکرارترین سؤال‌های حسابداری؛
7. اخبار و بخشنامه‌های جدید؛
8. نرم‌افزار راهبر سیستم «ایزی اینویس»؛
9. دعوت به اینستاگرام؛
10. خدمات مشاوره «منتورما»؛
11. تجربه‌های دانشجویان؛
12. همکاران راهبر حساب؛
13. Footer کامل.
...
پنج کارت در viewport Desktop/Tablet دیده می‌شوند:

1. بیش از ۲۰ دوره کاربردی؛
2. ارائه مدرک معتبر؛
3. کافه سؤال حسابداری؛
4. بیش از ۱۰۰ مشاور حرفه‌ای؛
5. پشتیبانی ۷/۲۴.
